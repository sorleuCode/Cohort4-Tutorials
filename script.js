...
const numTimesTwo = numberse.map((numb) => {
    return numb * numberse.indexOf(numb);
})

console.log(numTimesTwo);

// OBJECT, its methods and declaration types
...
const student1 = new Students(30, "Soliu", 12);
console.log(student1);

student1.isCool();

const student2 = new Students(10, "kola", 24)
